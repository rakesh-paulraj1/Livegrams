        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 text-sm border border-gray-200 rounded-full bg-gray-50">
            ...
            >
              Collaborate in real-time with your team. Create, share, and innovate together with Livegrams - 
              the seamless drawing platform built for modern teams.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                {status === 'authenticated' ? (
                  <div onClick={onStartClick} className="group cursor-pointer border border-gray-200 bg-white gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:shadow-lg transition-all">
                    <div className="border border-gray-200 bg-gray-900 h-[40px] rounded-full flex items-center justify-center text-white">
                    ...
                    <div className="text-gray-600 group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-gray-200">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
                  ...
                  <div onClick={() => signIn()} className="group cursor-pointer border border-gray-200 bg-white gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:shadow-lg transition-all">
                    <div className="border border-gray-200 bg-gray-900 h-[40px] rounded-full flex items-center justify-center text-white">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
