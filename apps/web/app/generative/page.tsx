		...
		<div className="flex h-screen w-full">
			...
			<div className="flex-1 min-w-0">
				<div className="h-full">
					<Tldraw licenseKey={"tldraw-2026-04-06/WyJGbk0taGVfNSIsWyIqIl0sMTYsIjIwMjYtMDQtMDYiXQ.dCGj13tRgD8vtF5/oDcJ47JqhS/hy/BRmHeD2+UL1YNjBW62oDLEBzN7iP7pNQAZmny/oikDgmiActZspZ58VA"} onMount={handleMount} />
				</div>
			</div>
